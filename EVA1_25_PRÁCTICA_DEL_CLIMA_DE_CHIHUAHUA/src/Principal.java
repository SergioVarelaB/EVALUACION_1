...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("escriba el numero del parametro que desea saber?\n"
        ...
        if(month>12){System.out.println("el mes no existe");}
        if(param>5){System.out.println("el parametro no existe");}
        else{
            System.out.println( caso +" del mes "+(month)+" es: "+matriz2[param-1][month-1]+"°C ");
        }
    }
}
